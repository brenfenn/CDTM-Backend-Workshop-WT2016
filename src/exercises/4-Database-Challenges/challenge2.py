...
db_add_user('Sheung')
db_add_user('Thilo')
db_add_user('Bob Ross')
#ADDING FIVE COOKIES
db_add_cookie(1,'Peanut Butter')
db_add_cookie(2,'Oreo')
db_add_cookie(3,'Chocolate Chip')
db_add_cookie(4,'Baumkuchen')
db_add_cookie(4, 'Bob Ross Special')